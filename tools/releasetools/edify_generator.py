...
class EdifyGenerator(object):
  ...
  def PrintZincBanner(self, android_version, zinc_version, build_id, build_date,
                                  security_patch, device):
    self.Print("----------------------------------------------")
    #if is_plus:
    #  self.Print("                ZincOS gapped")
    #  self.Print("                By the zinc team")
    #else:
    self.Print("                   ZincOS")
    self.Print("              By the zinc team")
    self.Print("----------------------------------------------")
    self.Print(" Android Version: %s"%(android_version))
    self.Print(" Zinc Version: %s"%(zinc_version))
