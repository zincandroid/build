...
""" % bcb_dev)
  ...
  zinc_version = target_info.GetBuildProp("ro.zinc.version")
  build_id = target_info.GetBuildProp("ro.build.id")
  build_date = target_info.GetBuildProp("ro.zinc.build_date")
  security_patch = target_info.GetBuildProp("ro.build.version.security_patch")
  device = target_info.GetBuildProp("ro.zinc.device")
  script.PrintZincBanner(android_version, zinc_version, build_id, build_date,
